...
WRITE_PATH_MRR <- paste0("/scratch_path/runSims/getVA/out_h2_", run_chunk, "_mrr.csv")
WRITE_PATH_MKR <- paste0("/scratch_path/runSims/getVA/out_h2_", run_chunk, "_mkr.csv")

# Load functions for loading relatedness/haplotype matrices
source("~/tests/runSims/getVA/R/helpFns.R")
